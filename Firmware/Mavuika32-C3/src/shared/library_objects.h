...
Adafruit_NeoPixel strip(NUM_LEDS, freeGPIOA, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel onboard_led(1, status_led_pin, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel majora(MAJORAS_LEDS, strip_pin, NEO_RGB + NEO_KHZ800); // 5mm PTH LEDs on Majora's Mask
